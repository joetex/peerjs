...
"use strict";var r=this&&this.__importStar||function(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var t in r)Object.hasOwnProperty.call(r,t)&&(e[t]=r[t]);return e.default=r,e};Object.defineProperty(exports,"__esModule",{value:!0});var e=r(require("peerjs-js-binarypack")),t=require("./supports"),o={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:"turn:0.peerjs.com:3478",username:"peerjs",credential:"peerjsp"}],sdpSemantics:"unified-plan"};exports.util=new(function(){function r(){this.CLOUD_HOST="0.peerjs.com",this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.chunkedMTU=16300,this.defaultConfig=o,this.browser=t.Supports.getBrowser(),this.browserVersion=t.Supports.getVersion(),this.supports=function(){var r,e={browser:t.Supports.isBrowserSupported(),webRTC:t.Supports.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;try{r=new RTCPeerConnection(o),e.audioVideo=!0;var n=void 0;try{n=r.createDataChannel("_PEERJSTEST",{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType="blob",e.binaryBlob=!t.Supports.isIOS}catch(a){}}catch(a){}finally{n&&n.close()}}catch(a){}finally{r&&r.close()}return e}(),this.pack=e.pack,this.unpack=e.unpack,this._dataCount=1}return r.prototype.noop=function(){},r.prototype.validateId=function(r){return!r||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(r)},r.prototype.chunk=function(r){for(var e=[],t=r.size,o=Math.ceil(t/exports.util.chunkedMTU),n=0,a=0;a<t;){var i=Math.min(t,a+exports.util.chunkedMTU),u=r.slice(a,i),s={__peerData:this._dataCount,n:n,data:u,total:o};e.push(s),a=i,n++}return this._dataCount++,e},r.prototype.blobToArrayBuffer=function(r,e){var t=new FileReader;return t.onload=function(r){r.target&&e(r.target.result)},t.readAsArrayBuffer(r),t},r.prototype.binaryStringToArrayBuffer=function(r){for(var e=new Uint8Array(r.length),t=0;t<r.length;t++)e[t]=255&r.charCodeAt(t);return e.buffer},r.prototype.randomToken=function(){return Math.random().toString(36).substr(2)},r.prototype.isSecure=function(){return!0},r}());
